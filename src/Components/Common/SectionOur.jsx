...
const SectionOur = ({ BG, Titulo, Descripcion, SubTitulo, SubDescripcion }) => {
    return (
        <div className={BG ? "flex flex-col items-center justify-center relative bg-white bg-cover bg-center my-8 h-90" : "flex flex-col items-center bg-[url(./Img/banner-5.png)] justify-center relative bg-cover bg-center w-full my-8 h-screen"}>
