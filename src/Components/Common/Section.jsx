...
const Section = ({ Titulo, Blanco, Descripcion, Buton, img }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="w-px bg-white absolute top-0 left-10"
      ...
      <div className="max-w-screen-xl flex flex-col lg:flex-row items-center justify-center lg:items-start">
        <div
          className={
            Blanco
              ...
              : "max-w-xl text-left ltr:sm:text-left rtl:sm:text-right text-white sm:mx-10 sm:my-6 pl-4"
          }
        >
        ...
        <div className="mt-8 lg:mt-0 lg:ml-auto">
          <img
            src={img}
            className="w-full lg:w-auto lg:max-w-4xl ml-auto"
            alt="Section Image"
          />
        </div>
      </div>
