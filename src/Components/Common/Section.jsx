...
const Section = ({ Titulo, Blanco, Descripcion, Buton, img }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="w-px bg-white absolute top-0 left-10 hidden sm:block "
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center sm:items-start max-h-screen overflow-y-auto"> {/* Add max-h-screen and overflow-y-auto for smaller screens */}
      <div
  className={
    Blanco
...
>
  ...
  {Buton && (
    <div className="mt-8 flex flex-wrap gap-4 justify-center lg:mr-96 sm:justify-center sm:mt-4"> {/* Adjust button spacing */}
