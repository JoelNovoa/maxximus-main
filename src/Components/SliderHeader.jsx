        ...
        <div style={{ position: 'relative', width: '100%', height: 'auto' }}>
            {images.map((image, index) => (
                ...
                <div key={index} className={`ease-linear ${index === currentSlide ? '' : 'hidden'}`} data-carousel-item={index === currentSlide ? 'active' : ''}>
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center items-center lg:items-start mx-4 lg:ml-32">
                        <div className="text-white max-w-xl text-center lg:text-left">
                            <h1 className="text-3xl lg:text-5xl font-extrabold">Become the modern agent</h1>
                            <br/>
                            <p className="mt-4 max-w-lg text-sm sm:text-base lg:text-lg text-white text-center lg:text-left">Welcome to Maxximum Realty where we revolutionize real estate marketing with innovative strategies that attract listings and buyers. Our approach redefines the lender-realtor relationship, fostering collaboration beyond the mortgage transaction.</p>
                            <div className="mt-8 flex flex-wrap gap-4 justify-center lg:justify-start">
                                <a
                                    href="#"
                                    className="block rounded-full bg-white px-6 py-3 text-sm font-medium text-black shadow hover:bg-gray-200 focus:outline-none focus:bg-gray-200"
